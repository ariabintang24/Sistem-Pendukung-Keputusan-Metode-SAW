...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav navbar-light sidebar sidebar-dark accordion" style="background-color: #0198A3;" id="accordionSidebar">
     
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-icon rotate-n-0">
        <img src="assets/logo-UNSIKA 5.png" alt="Logo" style="max-width: 50%; height: auto;">    
        </div>
