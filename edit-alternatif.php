...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		$update = mysqli_query($koneksi, "UPDATE alternatif SET alternatif = '$nama' WHERE id_alternatif = '$id_alternatif'");
		if ($update) {
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<a href="list-alternatif.php" class="btn btn-secondary btn-icon-split"><span class="icon text-white-50"><i class="fas fa-arrow-left"></i></span>
		<span class="text" style="background-color: #ffff; color:black ">Kembali</span>
	</a>
</div>
